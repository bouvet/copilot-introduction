...
Copy `instructions_template_powerbi.md` to `.github/copilot-instructions.md` in the workspace root. If the `.github` folder doesn’t exist in your repo, you can create it manually.
